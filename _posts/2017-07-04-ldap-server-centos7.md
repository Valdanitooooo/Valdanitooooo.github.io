...
```
![](https://ws1.sinaimg.cn/large/7bb8bd97gy1fu6oe8y369j20ru085aaf.jpg)
...
```
![](https://ws1.sinaimg.cn/large/7bb8bd97gy1fu6oe96up3j20rw0dhabb.jpg)
...
slaptest
```
![](https://ws1.sinaimg.cn/large/7bb8bd97gy1fu6oe944iej20ru05kt97.jpg)
- 更改LDAP数据库所有权：
```shell
...
```
![](https://ws1.sinaimg.cn/large/7bb8bd97gy1fu6oe9bpj9j20ru05f74p.jpg)
...
```
![](https://ws1.sinaimg.cn/large/7bb8bd97gy1fu6oe9hkhmj20ru0983z8.jpg)
...
```
![](https://ws1.sinaimg.cn/large/7bb8bd97gy1fu6oe9qnxgj20rw0icwg4.jpg)
- 在这里我们将数据库域名设为topenldap.com，管理员账号为admin，密码为之前生成的密码，日志级别设为-1
slapd -d ?命令可以获取OpenLDAP的日志级别
![](https://ws1.sinaimg.cn/large/7bb8bd97gy1fu6oe9lyb1j20ru0cmjsa.jpg)
- 将新配置发送到slapd服务器：
```shell
ldapmodify -Y EXTERNAL -H ldapi:/// -f /etc/openldap/changes.ldif
```
![](https://ws1.sinaimg.cn/large/7bb8bd97gy1fu6oe9ur6zj20s00cc74z.jpg)
...
objectClass: organizationalUnit
```
![](https://ws1.sinaimg.cn/large/7bb8bd97gy1fu6oe9z4hcj20ag09374n.jpg)
- 构建目录服务的结构：
```shell
ldapadd -x -W -D "cn=admin,dc=topenldap,dc=com" -f /etc/openldap/base.ldif
```
输入密码（123456）
![](https://ws1.sinaimg.cn/large/7bb8bd97gy1fu6oea48xuj20sa066wer.jpg)
...
```
设置密码为：userldap02
![](https://ws1.sinaimg.cn/large/7bb8bd97gy1fu6oeaasspj20nw08n750.jpg)
...
![](https://ws1.sinaimg.cn/large/7bb8bd97gy1fu6oea7owzj20aw03swei.jpg)
将这两行修改为之前我们自定义的域名
![](https://ws1.sinaimg.cn/large/7bb8bd97gy1fu6oeadm1cj20ch03xdfv.jpg)
...
```
![](https://ws1.sinaimg.cn/large/7bb8bd97gy1fu6oeah6idj20s80e4dh4.jpg)
...
```
![](https://ws1.sinaimg.cn/large/7bb8bd97gy1fu6oeal756j20os0hr0tt.jpg)
...
firewall-cmd --reload
```
![](https://ws1.sinaimg.cn/large/7bb8bd97gy1fu6oeapup5j20p1034t8s.jpg)
- 编辑/etc/rsyslog.conf文件并添加以下内容：
```shell
local4.*                     /var/log/ldaplog/ldap.log
```
![](https://ws1.sinaimg.cn/large/7bb8bd97gy1fu6oeatb2fj20mn06tglu.jpg)
- 重新启动rsyslog服务：
```shell
...
```
![](https://ws1.sinaimg.cn/large/7bb8bd97gy1fu6oeawrppj20rx0aa0td.jpg)
- 链接OpenLDAP服务器进行访问：
```shell
authconfig-tui
```
![](https://ws1.sinaimg.cn/large/7bb8bd97gy1fu6oeb0eekj20qa0f4mxt.jpg)
- Xsell工具在这里有个bug，总是更改我们配置好的内容，很无奈，只好用TDesktop登录172.26.17.36这台主机进行配置
- 执行authconfig-tui后先将左侧“使用 LDAP”和右侧“使用 LDAP 认证” 勾选上，下一步
![](https://ws1.sinaimg.cn/large/7bb8bd97gy1fu6oeb4cobj20k20c2q4e.jpg)
- 将服务器配置为我们的openldapServer机器的ip：172.26.17.35，确定
![](https://ws1.sinaimg.cn/large/7bb8bd97gy1fu6oeb83d6j20jz0bzt9k.jpg)
- 之后我们可以回到Xsell里继续操作了
首先测试一下客户端的配置是否有效
使用以下命令搜索ldap用户并检查输出。
```shell
...
```
![](https://ws1.sinaimg.cn/large/7bb8bd97gy1fu6oebc2qdj20kp01yjrd.jpg)
...
su - ldapuser01
```
![](https://ws1.sinaimg.cn/large/7bb8bd97gy1fu6oebi2c3j20tb03rt93.jpg)
